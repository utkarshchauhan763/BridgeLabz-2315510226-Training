// Creating Class StudentGradeCalculator2D to calculate grades using 2D array for marks
...
class StudentGradeCalculator2D {
    public static void main(String[] args) {
        ...
        // Create 2D array to store marks (students x subjects)
        ...
        // Display the results using 2D array
